...
//test5
    ...
    Plus(new Mult(l->at(2), l->at(3)), new Mult(l->at(3), l->at(4))).Execute() == (9+39.3)*150.2 ? msg = success : msg = failed;
    cout << counter << msg << endl;
    ++counter;
    //test 6
    try {
    ...
    //test 7
    Div(new Number(5), new Modulo(new Number(22), new Number(5))).Execute() == 2.5 ? msg = success : msg = failed;
    cout << counter << msg << endl;
    ++counter;

    //test 8
    Minus(new Neg(new Div(new Number(5), new Modulo(new Number(22), new Number(5)))), new Number(0)).Execute() == -2.5 ? msg = success : msg = failed;
    cout << counter << msg << endl;
    ++counter;
}
